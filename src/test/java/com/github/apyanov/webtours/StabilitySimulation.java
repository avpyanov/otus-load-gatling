...
public class StabilitySimulation extends Simulation {
...

    {
        ...
        setUp(
                OrderTicketScenario.orderTickets.injectClosed(
                        rampConcurrentUsers(0).to(180).during(Duration.of(5, ChronoUnit.MINUTES)),
                        constantConcurrentUsers(180).during(Duration.of(60, ChronoUnit.MINUTES))
                )
        )
                .assertions(
